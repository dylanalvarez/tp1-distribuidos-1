...
def main():
    ...
    send('{"log": {"app_id": "holi", "message": "holi", "timestamp": "2021-09-19T22:56:23-03:00"}}', config_params)
    send('{"log": {"app_id": "holi", "message": "holi", "timestamp": "2021-09-19T22:56:23-03:00", "log_tags": 2}}', config_params)
    ...
    send('{"query": {"app_id": "holi", "start_timestamp": "2021-09-19T22:56:23-03:00"}}', config_params)
    send('{"query": {"app_id": "holi", "end_timestamp": "2021-09-19T22:56:23-03:00"}}', config_params)
    # valid logs
    ...
    # valid queries
    send('{"query": {"app_id": "holi"}}', config_params)
